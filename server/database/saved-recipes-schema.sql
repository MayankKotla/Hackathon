...
-- This table stores user's saved recipes from both Recipe Generator and Social Feed
...
CREATE TABLE saved_recipes (
    ...
    source VARCHAR(50) DEFAULT 'recipe_generator', -- 'recipe_generator' or 'social_feed'
